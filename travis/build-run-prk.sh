...
case "$PRK_TARGET" in
    ...
    allshmem)
        ...
        $PRK_LAUNCHER -n $PRK_SHMEM_PROCS $PRK_TARGET_PATH/Transpose/transpose 10 1024 1 32
        $PRK_LAUNCHER -n $PRK_SHMEM_PROCS $PRK_TARGET_PATH/Transpose/transpose 10 1024 $(($PRK_SHMEM_PROCS/2)) 32
        $PRK_LAUNCHER -n $PRK_SHMEM_PROCS $PRK_TARGET_PATH/Transpose/transpose 10 1024 $(($PRK_SHMEM_PROCS-1)) 32
        ;;
    allupc)
        echo "UPC"
